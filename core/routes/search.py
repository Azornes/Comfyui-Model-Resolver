...
def register_search_routes(context: RouteContext):
    ...
    clear_civarchive_search_cache = context.get('clear_civarchive_search_cache')
    clear_civitai_search_cache = context.get('clear_civitai_search_cache')
    clear_huggingface_search_cache = context.get('clear_huggingface_search_cache')
    clear_lora_manager_archive_search_cache = context.get('clear_lora_manager_archive_search_cache')
    extract_sha256_from_metadata = context.get('extract_sha256_from_metadata')
    format_size_bytes = context.get('format_size_bytes')
    ...
    resolve_urn = context.get('resolve_urn')
    routes = context.get('routes')
    search_civarchive_for_file = context.get('search_civarchive_for_file')
    search_civitai = context.get('search_civitai')
    search_civitai_for_file = context.get('search_civitai_for_file')
    search_huggingface_for_file = context.get('search_huggingface_for_file')
    search_local_matches_by_hash = context.get('search_local_matches_by_hash')
    search_lora_manager_archive_for_file = context.get('search_lora_manager_archive_for_file')
