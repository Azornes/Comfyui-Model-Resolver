...
def register_civitai_search_routes(context: RouteContext):
    ...
    find_external_metadata_sidecar_path = context.get('find_external_metadata_sidecar_path')
    find_local_file_path = context.get('find_local_file_path')
    ...
    get_model_resolver_sidecar_path = context.get('get_model_resolver_sidecar_path')
    ...
    request_public_url = context.get('request_public_url')
    ...
    web = context.get('web')
    write_model_resolver_metadata = context.get('write_model_resolver_metadata')
