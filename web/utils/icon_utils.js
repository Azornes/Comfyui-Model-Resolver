...
const SVG_ICONS = {
    ...
    internalLink: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M8 10v6h6"></path><path d="M21 3 8 16"></path><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path></svg>`,
    ...
    windowMaximize: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="1.45" stroke-linecap="square" stroke-linejoin="miter" aria-hidden="true"><rect x="7.5" y="7.5" width="9" height="9"></rect></svg>`,
    windowRestore: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="1.45" stroke-linecap="square" stroke-linejoin="miter" aria-hidden="true"><path d="M9 9.5h7.5V17H9z"></path><path d="M7 14.5H5.5v-9H14V7"></path></svg>`,
    x: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="1.65" stroke-linecap="square" aria-hidden="true"><path d="M7 7l10 10"></path><path d="M17 7 7 17"></path></svg>`,
