...
PROJECT_VERSION_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "pyproject.toml")
...
def _get_project_version_info() -> dict[str, Any]:
    ...
    if not cache_is_fresh:
        latest_version = None
        try:
            from .core.network_utils import request_source_response
        ...
        try:
            ...
            if download_available:
                ...
                async def get_project_version(request):
                    ...
                    return web.json_response(await asyncio.to_thread(_get_project_version_info))
